...
void IconHelper::setIcon(QLabel* label, const QString& color, int icon, int size) {
...
void IconHelper::setIcon(QAbstractButton* button, const QString& color, int icon, int size) {
    iconfont.setPixelSize(size);
...
void IconHelper::setIcon(QAbstractButton* button, const QColor& color, int icon, int size) {
    QPixmap pix = getPixmap(icon, size, color);
    button->setIcon(QIcon(pix));
    button->setIconSize(QSize(static_cast<int>(size), static_cast<int>(size)));
}

QPixmap IconHelper::getPixmap(int icon, int size, const QColor& color) {
